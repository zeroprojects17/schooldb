...
const firebaseConfig = {
  apiKey: "AIzaSyBLzWWJb9OHUe101F0RLvtgKZ4F-0mrpoY",
  authDomain: "schooldb-aaf06.firebaseapp.com",
  databaseURL: "https://schooldb-aaf06-default-rtdb.asia-southeast1.firebasedatabase.app/",
  projectId: "schooldb-aaf06",
  storageBucket: "schooldb-aaf06.appspot.com",
  messagingSenderId: "1056264797823",
  appId: "1:1056264797823:web:ab123cd456ef7890ghij"
};
...
function App() {
  ...
  return (
    <div className={`container-fluid text-center ${darkMode ? 'bg-dark text-white' : ''}`} style={{ minHeight: '100vh' }}>
      <h1 className="my-4">SCHOOL DATABASE SYSTEM</h1>
